...
namespace Mycostum\IntegraCommerce\Helper\Catalog\Product;
...
class Attribute extends AbstractHelper
{
    ...
    {
        $groupName = 'IntegraCommerce IntegraCommerce';
        $groupCode = 'mycostum-integracommerce';

        /** @var \Mycostum\IntegraCommerce\Model\ResourceModel\Eav\Entity\Attribute\Set $resource */
        $resource = $this->context
            ->objectManager()
            ->create(\Mycostum\IntegraCommerce\Model\ResourceModel\Eav\Entity\Attribute\Set::class);
     ...
     * @return $this
     */
    public function initIntegraCommerceAttributeGroup($groupName)
    {

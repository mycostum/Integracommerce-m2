...
namespace Mycostum\IntegraCommerce\Model\ResourceModel\Customer\Attributes;

use Magento\Framework\Model\ResourceModel\Db\AbstractDb;

class Mapping extends AbstractDb
{
    const MAIN_TABLE = 'mycostum_integracommerce_customer_attributes_mapping';
    ...
    {
        $this->_init('mycostum_integracommerce_customer_attributes_mapping', 'id');
    }
}

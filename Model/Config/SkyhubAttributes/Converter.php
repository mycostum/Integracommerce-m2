...
class Converter implements ConverterInterface
{
    ...
    public function convert($source)
    {
         ...
         */
        $productAttributesNode = $xpath->evaluate('/config/integracommerce/catalog/product/attributes/attribute');
        $productBlacklistNode = $xpath->evaluate('/config/integracommerce/catalog/product/attributes/blacklist/attribute');
        $customerAttributesNode = $xpath->evaluate('/config/integracommerce/customer/attributes/attribute');
        $customerBlacklistNode = $xpath->evaluate('/config/integracommerce/customer/attributes/blacklist/attribute');

...
class Category extends AbstractQueue
{
    ...
    public function create(Schedule $schedule)
    {
        ...
        $this->getQueueResource()->queue(
            $categoryIds,
            \Mycostum\IntegraCommerce\Model\Entity::TYPE_CATALOG_CATEGORY,
    ...
    public function execute(Schedule $schedule)
    {
        ...
        if ($successQueueIds || $failedQueueIds) {
            $this->getQueueResource()
                ->removeFromQueue($successQueueIds, \Mycostum\IntegraCommerce\Model\Entity::TYPE_CATALOG_CATEGORY);
    ...
    public function executeIntegration(Schedule $schedule, StoreInterface $store)
    {
        ...
        foreach ($categoryIds as $categoryId) {
            ...
            /** @var \Mycostum\IntegraCommerce\Integration\Integrator\Catalog\Category $integrator */
            $integrator = $this->createObject(\Mycostum\IntegraCommerce\Integration\Integrator\Catalog\Category::class);

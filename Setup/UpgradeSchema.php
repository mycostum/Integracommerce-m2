...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    {
        $tableName = $this->getTable('mycostum_integracommerce_customer_attributes_mapping');
        ...
        $table = $this->getConnection()
            ...
            ->setComment('IntegraCommerce Customer Attributes Mapping.');;
    ...
    {
        $tableName = $this->getTable('mycostum_integracommerce_customer_attributes_mapping_options');
        ...
        $table = $this->getConnection()
            ...
            ->setComment('IntegraCommerce Customer Attribute Options Mapping.');

        /** Add Unique Index */
        $this->addTableIndex($table, ['customer_attributes_mapping_id', 'integracommerce_code'], AdapterInterface::INDEX_TYPE_UNIQUE);

        /** Add Foreign Key */
        $this->addTableForeignKey($table, 'customer_attributes_mapping_id', 'mycostum_integracommerce_customer_attributes_mapping', 'id');

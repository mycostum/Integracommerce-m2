...
namespace Mycostum\IntegraCommerce\Ui\Component\Listing\Column\Product\Attributes;
...
class MappingActions extends Column
{
    ...
    /** @var string */
    const URL_PATH_EDIT        = 'mycostum_integracommerce/catalog_product_attributes_mapping/edit';
    const URL_PATH_CREATE      = 'mycostum_integracommerce/catalog_product_attributes_mapping/autoCreate';
    const URL_PATH_UNASSOCIATE = 'mycostum_integracommerce/catalog_product_attributes_mapping/unassociate';

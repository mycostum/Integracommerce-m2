...
namespace Mycostum\IntegraCommerce\Block\System\Config\Cron;

use Mycostum\IntegraCommerce\Block\System\Config\AbstractConfig;

class Heartbeat extends AbstractConfig
{
    
    /** @var \Mycostum\IntegraCommerce\Cron\HeartbeatFactory */
    protected $heartbeatFactory;
    
    /** @var \Mycostum\IntegraCommerce\Cron\Heartbeat */
    ...
    public function __construct(
        ...
        \Mycostum\IntegraCommerce\Cron\HeartbeatFactory $heartbeatFactory,
        array $data = []
    ) {
    ...
    /**
     * @return \Mycostum\IntegraCommerce\Cron\Heartbeat
     */

...
class SalesOrderStatus extends AbstractConfig
{
    ...
    {
        $status = (string) $this->getIntegraCommerceModuleConfig('new_order_status', $this->group, $scopeCode);
    ...
    {
        $status = (string) $this->getIntegraCommerceModuleConfig('approved_order_status', $this->group, $scopeCode);
    ...
    {
        $status = (string) $this->getIntegraCommerceModuleConfig('delivered_order_status', $this->group, $scopeCode);
    ...
    {
        $status = (string) $this->getIntegraCommerceModuleConfig('shipment_exception_order_status', $this->group, $scopeCode);

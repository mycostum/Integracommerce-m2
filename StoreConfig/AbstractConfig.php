...
abstract class AbstractConfig
{
     ...
     * @return mixed
     */
    public function getIntegraCommerceModuleConfig($field, $group = null, $scopeCode = null, $scopeType = null)
    {
        if (empty($group)) {
            $group = $this->group;
        }

        return $this->getStoreConfig($field, $group, 'mycostum_integracommerce', $scopeCode, $scopeType);
    }
     ...
     * @return array
     */
    public function getIntegraCommerceModuleConfigAsArray($field, $group = null, $scopeCode = null, $scopeType = null)
    {
        $values      = $this->getIntegraCommerceModuleConfig($field, $group, $scopeCode, $scopeType);

...
namespace Mycostum\IntegraCommerce\Console\Integration\Sales;

use Mycostum\IntegraCommerce\Helper\Sales\Order\Created\Message;
use Mycostum\IntegraCommerce\Integration\Integrator\Sales\Order as OrderIntegrator;
use Mycostum\IntegraCommerce\Integration\Processor\Sales\Order as OrderProcessor;
...
class IntegrateOrder extends AbstractSales
{
    ...
    {
        $this->setName('integracommerce:integrate:order')
            ->setDescription('Import orders from IntegraCommerce service.')
            ->setDefinition([
                new InputOption(
                    self::INPUT_KEY_ORDER_CODE,
                    'o',
                    InputOption::VALUE_OPTIONAL | InputOption::VALUE_IS_ARRAY,
                    'The order code in IntegraCommerce that will be imported to Magento.'
                ),

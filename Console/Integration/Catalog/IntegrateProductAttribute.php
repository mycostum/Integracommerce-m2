...
use Mycostum\IntegraCommerce\Integration\Integrator\Catalog\Product\Attribute as ProductAttributeIntegrator;
...
class IntegrateProductAttribute extends AbstractCatalog
{
    ...
    {
        $this->setName('integracommerce:integrate:product-attribute')

...
use Mycostum\IntegraCommerce\Integration\Integrator\Catalog\Category as CategoryIntegrator;
...
class IntegrateCategory extends AbstractCatalog
{
    ...
    {
        $this->setName('integracommerce:integrate:category')
    ...
    protected function processExecute(InputInterface $input, OutputInterface $output, StoreInterface $store)
    {
        ...
        foreach ($categoryIds as $categoryId) {
            ...
            /** @var \IntegraCommerce\Api\Handler\Response\HandlerInterfaceSuccess|\IntegraCommerce\Api\Handler\Response\HandlerInterfaceException $response */

...
use Mycostum\IntegraCommerce\Integration\Transformer\Catalog\ProductFactory as ProductTransformerFactory;
...
class Product extends AbstractCatalog
{
     ...
     *
     * @return bool|\IntegraCommerce\Api\Handler\Response\HandlerInterface
     */
    ...
    public function createOrUpdate(ProductInterface $product)
    {
        ...
        if (true == $exists) {
             ...
             * Update Product
             *
             * @var bool|\IntegraCommerce\Api\Handler\Response\HandlerInterface $response
             */
    ...
    public function create(ProductInterface $product)
    {
        ...
        /** @var \IntegraCommerce\Api\EntityInterface\Catalog\Product $interface */
    ...
    /**
     * @return \Mycostum\IntegraCommerce\Integration\Transformer\Catalog\Product
     */

...
class Order extends AbstractSales
{
    ...
    public function invoice($orderId, $invoiceKey)
    {
        ...
        /** @var \IntegraCommerce\Api\Handler\Response\HandlerInterface $result */
    ...
    /**
     * @return \IntegraCommerce\Api\EntityInterface\Sales\Order
     */
    ...
    /**
     * validate order data retrieved from IntegraCommerce API
     *
     * @param array $order
     * @return bool
     */
